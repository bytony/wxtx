...
<div id="wp" class="wp">
  ...
  <a href="index.php?pluginid=vote&act=modify" title="新增投票" class="btnGrayS vm bigbtn">新增投票</a>　
          ...
          <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
				...
				<th class="keywords">投票标题</th>
				<th class="keywords">参与人数</th>
				<th class="answer">投票内容</th>
				<th class="time">时间</th>
			  ...
			  <td><?php echo $v['vote_total'];?></td>
			  <td><?php echo $v['vote_content'];?></td>
			  <td><?php echo date('Y-m-d',$v['updatetime']);?></td>
			  <td>预览 <a href="index.php?pluginid=vote&act=modify&updateid=<?php echo $v['id'];?>">编辑</a> <a href="index.php?pluginid=vote&act=del&updateid=<?php echo $v['id'];?>" onclick="return checkdel();">删除</a></td>
			  </tr>
			  <?php }?>
 <tr>
