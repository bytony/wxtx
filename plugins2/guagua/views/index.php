...
<div id="wp" class="wp">
  ...
  <a href="index.php?pluginid=guagua&act=modify" title="新增刮刮卡" class="btnGrayS vm bigbtn">新增刮刮卡</a>　
          ...
          <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <td><?php echo $v['guagua_title'];?></td>
			  <td><?php echo $v['guagua_total'];?></td>
			  <td><?php echo $v['guagua_content'];?></td>
			  <td><?php echo date('Y-m-d',$v['updatetime']);?></td>
			  <td>预览 <a href="index.php?pluginid=guagua&act=modify&updateid=<?php echo $v['id'];?>">编辑</a> <a href="index.php?pluginid=guagua&act=del&updateid=<?php echo $v['id'];?>" onclick="return checkdel();">删除</a></td>
			  </tr>
			  <?php }?>
 <tr>
