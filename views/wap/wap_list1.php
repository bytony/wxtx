...
foreach($infolist['data'] as $k=>$v){?>      
<li>
<a href="index.php?con=wap&act=item&id=<?php echo $v['id'];?><?php echo $ext;?>">
<h2><?php echo $v['title'];?></h2>
<div class="img"><img src="<?php echo $v['face'];?>"></div>
<p class="onlyheight"><?php echo strip_tags($v['intro']);?></p>
...
<div class="c-p-pre  c-p-grey  "><span class="c-p-p"><em></em></span><a href="index.php?con=wap&act=list&cid=<?php echo $cid;?><?php echo $ext;?>&page=<?php echo $infolist['page']->prevPage;?>">上一页</a></div>
<div class="c-p-cur">
...
<div class="c-p-next  c-p-grey  "><a href="index.php?con=wap&act=list&cid=<?php echo $cid;?><?php echo $ext;?>&page=<?php echo $infolist['page']->nextPage;?>">下一页</a><span class="c-p-p"><em></em></span></div>
</section>
</div>
</section>
</div>
<script>
function dourl(url){
location.href= 'http://www.im61.com/index.php'+url;
}
function changepage()
{
	p=document.getElementById('oppage').value;
	location.href= 'index.php?con=wap&act=list&cid=<?php echo $cid;?><?php echo $ext;?>&page='+p;
}
</script>
