...
JQTWEET = {
	...
	user: 'webbudesign', // Your Twitter Username
	...
	loadTweets: function() {
		$.ajax({
			...
			success: function(data, textStatus, xhr) {
			 ...
			 var html = '<div class="tweet"><i class="icon-twitter" style="font-size:14px;"></i> TWEET_TEXT<div class="time">AGO</div><div class="dividertwitter"></div>';
