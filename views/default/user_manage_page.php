...
<!-- ////////////////////////////////// -->
  ...
  <a href="index.php?con=user&act=pagemodify" title="新增page" class="btnGrayS vm bigbtn"><img src="static/theme/default/img/index/text.png" class="vm">新增page</a>　
...
<th class="edit norightborder">操作</th>
			  ...
			  <td>预览 <a href="index.php?con=user&act=pagemodify&updateid=<?php echo $v['id'];?>">编辑</a> <a href="index.php?con=user&act=infodel&updateid=<?php echo $v['id'];?>" onclick="return checkdel();">删除</a></td>
			  </tr>
			  <?php }?>
