...
<input type="hidden" name="act" value="textmodify">
...
<tr>
  ...
  <td>
  <?php include "user_widget_keywords.php";?>
  </td>
  <td>&nbsp;</td>
</tr>
...
<img src="static/theme/default/img/index/chaolianjie.jpg" alt="文字超链接效果">	
  ...
  <th></th>
  <td><button type="submit" name="button" class="btnGreen left">保存</button>　<a href="index.php?con=user&act=imagemodify" class="btnGray vm">切换到图文模式</a>　<a href="index.php?ac=importtxt&amp;id=3699" class="btnGray vm">取消</a>
