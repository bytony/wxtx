    ...
    <div class="developer">
      ...
      <div class="tableContent">
        ...
        <div class="content">
		 ...
		 <input type="hidden" name="act" value="imagemodify">
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>
               ...
               <tr>
                ...
                <tr>
                  <th></th>
                  <td><button type="submit" name="button" class="btnGreen">保存</button>　<a href="index.php?con=user&act=image" class="btnGray vm">取消</a></td>
                </tr>
              </tbody>
            </table>
            <?php if($info['id']>0){?>
